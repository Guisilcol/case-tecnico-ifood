-- Criação da tabela bronze: nyc_taxi_data_green

CREATE TABLE IF NOT EXISTS bronze_db.nyc_taxi_data_green (
  vendorid DOUBLE COMMENT 'Identificador do fornecedor LPEP que forneceu o registro',
  lpep_pickup_datetime TIMESTAMP COMMENT 'Data e hora em que o taxímetro foi acionado',
  lpep_dropoff_datetime TIMESTAMP COMMENT 'Data e hora em que o taxímetro foi desligado',
  ...
  ehail_fee DOUBLE COMMENT 'Taxa de serviço de e-hail',
  ...
  trip_type DOUBLE COMMENT 'Código indicando se a viagem foi uma corrida de rua ou despacho',
...
COMMENT 'Tabela bronze com dados de táxis verdes de NYC';
